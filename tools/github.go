...
func RegisterGitHubTool(s *server.MCPServer) {
	...
	// approve pr
	approvePRTool := mcp.NewTool("github_approve_pr",
	...
	s.AddTool(approvePRTool, util.ErrorGuard(approvePRHandler))
}

func listReposHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	ownerVal, ok := request.Params.Arguments["owner"]
	if !ok || ownerVal == nil {
	...
	repoTypeVal, ok := request.Params.Arguments["type"]
...
func getRepoHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func getPullRequestHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
...
func commentOnPullRequestHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
	number := request.Params.Arguments["number"].(string)
...
func getGitHubFileContentHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
	path := request.Params.Arguments["path"].(string)
	ref := ""
	if refArg, ok := request.Params.Arguments["ref"]; ok {
		ref = refArg.(string)
	}
...
func createPullRequestHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	head := request.Params.Arguments["head"].(string)
	base := request.Params.Arguments["base"].(string)
	body := ""
	if bodyArg, ok := request.Params.Arguments["body"]; ok {
		body = bodyArg.(string)
	}
...
func listIssuesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	includeBody := false
	if includeBodyVal, exists := request.Params.Arguments["include_body"]; exists {
...
func getIssueHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
	number := request.Params.Arguments["number"].(string)
...
func commentOnIssueHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
	number := request.Params.Arguments["number"].(string)
	comment := request.Params.Arguments["comment"].(string)
...
func issueActionHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
	number := request.Params.Arguments["number"].(string)
	action := request.Params.Arguments["action"].(string)
...
func approvePRHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	owner := request.Params.Arguments["owner"].(string)
	repo := request.Params.Arguments["repo"].(string)
	number := request.Params.Arguments["number"].(string)
